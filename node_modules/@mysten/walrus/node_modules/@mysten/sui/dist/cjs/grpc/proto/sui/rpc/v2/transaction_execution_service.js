...
var import_struct = require("../../../google/protobuf/struct");
...
class ExecuteTransactionRequest$Type extends import_runtime.MessageType {
  constructor() {
    super("sui.rpc.v2.ExecuteTransactionRequest", [
      ...
      { no: 2, name: "signatures", kind: "message", repeat: 1, T: () => import_signature.UserSignature },
...
const TransactionExecutionService = new import_runtime_rpc.ServiceType("sui.rpc.v2.TransactionExecutionService", [
