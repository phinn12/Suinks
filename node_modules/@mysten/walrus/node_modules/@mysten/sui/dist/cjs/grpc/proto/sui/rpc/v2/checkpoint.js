...
var import_checkpoint_contents = require("./checkpoint_contents");
var import_signature = require("./signature");
var import_checkpoint_summary = require("./checkpoint_summary");
class Checkpoint$Type extends import_runtime.MessageType {
  constructor() {
    super("sui.rpc.v2.Checkpoint", [
      ...
      { no: 6, name: "transactions", kind: "message", repeat: 1, T: () => import_executed_transaction.ExecutedTransaction },
