...
var import_balance_change = require("./balance_change");
...
class ExecutedTransaction$Type extends import_runtime.MessageType {
  constructor() {
    super("sui.rpc.v2.ExecutedTransaction", [
      ...
      { no: 3, name: "signatures", kind: "message", repeat: 1, T: () => import_signature.UserSignature },
      ...
      { no: 8, name: "balance_changes", kind: "message", repeat: 1, T: () => import_balance_change.BalanceChange },
