...
class UserSignature$Type extends import_runtime.MessageType {
  constructor() {
    super("sui.rpc.v2.UserSignature", [
      ...
      { no: 2, name: "scheme", kind: "enum", opt: true, T: () => ["sui.rpc.v2.SignatureScheme", import_signature_scheme.SignatureScheme] },
...
class SimpleSignature$Type extends import_runtime.MessageType {
  constructor() {
    super("sui.rpc.v2.SimpleSignature", [
      { no: 1, name: "scheme", kind: "enum", opt: true, T: () => ["sui.rpc.v2.SignatureScheme", import_signature_scheme.SignatureScheme] },
      {
        no: 2,
        name: "signature",
        kind: "scalar",
