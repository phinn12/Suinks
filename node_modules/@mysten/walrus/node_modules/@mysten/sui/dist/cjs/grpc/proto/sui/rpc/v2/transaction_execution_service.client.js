...
var import_transaction_execution_service = require("./transaction_execution_service");
...
class TransactionExecutionServiceClient {
  ...
  executeTransaction(input, options) {
    ...
    return (0, import_runtime_rpc.stackIntercept)("unary", this._transport, method, opt, input);
  }
  /**
