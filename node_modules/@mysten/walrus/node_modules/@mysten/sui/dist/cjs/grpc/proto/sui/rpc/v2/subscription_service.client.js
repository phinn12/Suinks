...
var import_subscription_service = require("./subscription_service");
...
class SubscriptionServiceClient {
  ...
  subscribeCheckpoints(input, options) {
    ...
    return (0, import_runtime_rpc.stackIntercept)("serverStreaming", this._transport, method, opt, input);
  }
}
