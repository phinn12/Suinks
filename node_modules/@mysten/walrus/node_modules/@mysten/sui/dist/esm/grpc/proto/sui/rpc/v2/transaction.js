...
class GasPayment$Type extends MessageType {
  constructor() {
    super("sui.rpc.v2.GasPayment", [
      { no: 1, name: "objects", kind: "message", repeat: 1, T: () => ObjectReference },
      {
        no: 2,
        name: "owner",
        kind: "scalar",
...
class ProgrammableTransaction$Type extends MessageType {
  constructor() {
    super("sui.rpc.v2.ProgrammableTransaction", [
      ...
      { no: 2, name: "commands", kind: "message", repeat: 1, T: () => Command }
    ]);
  }
}
...
class MoveCall$Type extends MessageType {
  constructor() {
    super("sui.rpc.v2.MoveCall", [
      ...
      { no: 5, name: "arguments", kind: "message", repeat: 1, T: () => Argument }
    ]);
  }
}
...
class TransferObjects$Type extends MessageType {
  constructor() {
    super("sui.rpc.v2.TransferObjects", [
      { no: 1, name: "objects", kind: "message", repeat: 1, T: () => Argument },
...
class SplitCoins$Type extends MessageType {
  constructor() {
    super("sui.rpc.v2.SplitCoins", [
      ...
      { no: 2, name: "amounts", kind: "message", repeat: 1, T: () => Argument }
    ]);
  }
}
...
class MergeCoins$Type extends MessageType {
  constructor() {
    super("sui.rpc.v2.MergeCoins", [
      { no: 1, name: "coin", kind: "message", T: () => Argument },
      { no: 2, name: "coins_to_merge", kind: "message", repeat: 1, T: () => Argument }
    ]);
  }
}
...
class MakeMoveVector$Type extends MessageType {
  constructor() {
    super("sui.rpc.v2.MakeMoveVector", [
      ...
      { no: 2, name: "elements", kind: "message", repeat: 1, T: () => Argument }
    ]);
  }
}
...
class ChangeEpoch$Type extends MessageType {
  constructor() {
    super("sui.rpc.v2.ChangeEpoch", [
      ...
      { no: 8, name: "system_packages", kind: "message", repeat: 1, T: () => SystemPackage }
    ]);
  }
}
...
class CanceledTransaction$Type extends MessageType {
  constructor() {
    super("sui.rpc.v2.CanceledTransaction", [
      ...
      { no: 2, name: "version_assignments", kind: "message", repeat: 1, T: () => VersionAssignment }
    ]);
  }
}
...
class ConsensusDeterminedVersionAssignments$Type extends MessageType {
  constructor() {
    super("sui.rpc.v2.ConsensusDeterminedVersionAssignments", [
      ...
      { no: 3, name: "canceled_transactions", kind: "message", repeat: 1, T: () => CanceledTransaction }
    ]);
  }
}
...
class AuthenticatorStateUpdate$Type extends MessageType {
  constructor() {
    super("sui.rpc.v2.AuthenticatorStateUpdate", [
      ...
      { no: 3, name: "new_active_jwks", kind: "message", repeat: 1, T: () => ActiveJwk },
      {
        no: 4,
...
class EndOfEpochTransaction$Type extends MessageType {
  constructor() {
    super("sui.rpc.v2.EndOfEpochTransaction", [
      { no: 1, name: "transactions", kind: "message", repeat: 1, T: () => EndOfEpochTransactionKind }
    ]);
  }
}
...
class ExecutionTimeObservations$Type extends MessageType {
  constructor() {
    super("sui.rpc.v2.ExecutionTimeObservations", [
      ...
      { no: 2, name: "observations", kind: "message", repeat: 1, T: () => ExecutionTimeObservation }
    ]);
  }
}
...
class ExecutionTimeObservation$Type extends MessageType {
  constructor() {
    super("sui.rpc.v2.ExecutionTimeObservation", [
      ...
      { no: 3, name: "validator_observations", kind: "message", repeat: 1, T: () => ValidatorExecutionTimeObservation }
    ]);
  }
}
