...
class Package$Type extends MessageType {
  constructor() {
    super("sui.rpc.v2.Package", [
      ...
      { no: 5, name: "type_origins", kind: "message", repeat: 1, T: () => TypeOrigin },
      { no: 6, name: "linkage", kind: "message", repeat: 1, T: () => Linkage }
    ]);
  }
}
...
class Module$Type extends MessageType {
  constructor() {
    super("sui.rpc.v2.Module", [
      ...
      { no: 3, name: "datatypes", kind: "message", repeat: 1, T: () => DatatypeDescriptor },
      { no: 4, name: "functions", kind: "message", repeat: 1, T: () => FunctionDescriptor }
    ]);
  }
}
...
class DatatypeDescriptor$Type extends MessageType {
  constructor() {
    super("sui.rpc.v2.DatatypeDescriptor", [
      ...
      { no: 5, name: "abilities", kind: "enum", repeat: 1, T: () => ["sui.rpc.v2.Ability", Ability] },
      { no: 6, name: "type_parameters", kind: "message", repeat: 1, T: () => TypeParameter },
      { no: 7, name: "kind", kind: "enum", opt: true, T: () => ["sui.rpc.v2.DatatypeDescriptor.DatatypeKind", DatatypeDescriptor_DatatypeKind] },
      { no: 8, name: "fields", kind: "message", repeat: 1, T: () => FieldDescriptor },
      { no: 9, name: "variants", kind: "message", repeat: 1, T: () => VariantDescriptor }
    ]);
  }
}
...
class TypeParameter$Type extends MessageType {
  constructor() {
    super("sui.rpc.v2.TypeParameter", [
      { no: 1, name: "constraints", kind: "enum", repeat: 1, T: () => ["sui.rpc.v2.Ability", Ability] },
      {
        no: 2,
        name: "is_phantom",
        kind: "scalar",
...
class VariantDescriptor$Type extends MessageType {
  constructor() {
    super("sui.rpc.v2.VariantDescriptor", [
      ...
      { no: 3, name: "fields", kind: "message", repeat: 1, T: () => FieldDescriptor }
    ]);
  }
}
...
class OpenSignatureBody$Type extends MessageType {
  constructor() {
    super("sui.rpc.v2.OpenSignatureBody", [
      ...
      { no: 3, name: "type_parameter_instantiation", kind: "message", repeat: 1, T: () => OpenSignatureBody },
      {
        no: 4,
        name: "type_parameter",
        kind: "scalar",
...
class FunctionDescriptor$Type extends MessageType {
  constructor() {
    super("sui.rpc.v2.FunctionDescriptor", [
      ...
      { no: 7, name: "type_parameters", kind: "message", repeat: 1, T: () => TypeParameter },
      { no: 8, name: "parameters", kind: "message", repeat: 1, T: () => OpenSignature },
      { no: 9, name: "returns", kind: "message", repeat: 1, T: () => OpenSignature }
    ]);
  }
}
