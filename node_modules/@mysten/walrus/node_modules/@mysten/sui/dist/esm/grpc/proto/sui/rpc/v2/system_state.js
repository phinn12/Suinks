...
class SystemState$Type extends MessageType {
  constructor() {
    super("sui.rpc.v2.SystemState", [
      ...
      { no: 8, name: "validator_report_records", kind: "message", repeat: 1, T: () => ValidatorReportRecord },
...
class ValidatorSet$Type extends MessageType {
  constructor() {
    super("sui.rpc.v2.ValidatorSet", [
      ...
      { no: 2, name: "active_validators", kind: "message", repeat: 1, T: () => Validator },
      ...
      { no: 8, name: "at_risk_validators", kind: "map", K: 9, V: {
        kind: "scalar",
        T: 4,
        L: 0
        /*LongType.BIGINT*/
